...
[cocoNLP](https://github.com/fighting41love/cocoNLP)是一个中文nlp工具，可以从文本中提取信息，下面将会列出其中一些常用功能。
...
本功能点的主要目的是抽取新闻的关键骨干信息。抽取出得结果是多组关键词组成的短语，每组短语表达一项信息。具体使用方法如下所示：
...
>>> # 获取关键词短语，按照score从高到低排序
>>> ranked_words = r.get_ranked_phrases()

>>> # 获取关键词短语以及对应的score，按照score从高到低排序
